        ...
        {[...wagons]
          ...
          .map((w) => (
            <Link
              ...
              to="/wagons/$id"
              params={{ id: w.id }}
              className="grid grid-cols-12 gap-4 px-5 py-4 items-center border-b border-white/5 last:border-0 hover:bg-white/[0.03] transition relative group"
            >
              {w.risk === "Critical" && (
              ...
              <div className="col-span-2 flex items-center justify-between gap-2">
                ...
                <ChevronRight className="size-4 text-white/30 group-hover:text-white" />
              </div>
            </Link>
          ))}
      </div>
